...
import PABD_C.Database_TokoObat.exceptions.IllegalOrphanException;
import PABD_C.Database_TokoObat.exceptions.NonexistentEntityException;
import PABD_C.Database_TokoObat.exceptions.PreexistingEntityException;
...
public class ObatJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("PABD_C_Database_TokoObat_jar_0.0.1-SNAPSHOTPU");
